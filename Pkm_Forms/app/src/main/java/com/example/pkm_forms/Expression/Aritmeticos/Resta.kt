                ...
                when(rightType){
                    ...
                    TypeData.DECIMAL ->{
                        ...
                        if (leftValue is Number && rightValue is Number){
                            ...
                            throw Exception("No se pueden restar valores no numericos")
                        }
                    }
                    else -> {
                        val error: SintaxError =
                            SintaxError("SEMANTICO", "Resta invalida", this.line, this.column);
                        return error
                    }
                }
            }
            TypeData.DECIMAL -> {
                when(rightType){
                    ...
                    TypeData.DECIMAL -> {
                        ...
                        val error: SintaxError = SintaxError("SEMANTICO", "Resta invalida", this.line, this.column)
                        return error
                    }
                }
            }
